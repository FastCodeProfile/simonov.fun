var RENDERER = {
  ...
  setParameters: function () {
    ...
    this.$canvas = $('<canvas style="opacity: .5; "/>');
    this.context = this.$canvas.appendTo(this.$container).get(0).getContext('2d');
    this.particles = [];
    this.watchIds = [];
    this.gravity = { x: 0, y: 0, on: false, radius: 100, gravity: false };
  },
  setup: function () {
  ...
  createParticles: function () {
    for (var i = 0, count = (this.BASE_PARTICLE_COUNT * this.width / 850 * this.height / 850) | 0; i < count; i++) {
